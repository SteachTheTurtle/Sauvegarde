...
public class Ville {
	 ...
	 * System.out.println("Création d'une ville avec des paramètres !"); nomVille =
	 * pNom; nomPays = pPays; nbreHabitants = pNbre; //On incrémente nos variables à
	 * chaque appel aux constructeurs nbreInstances++; nbreInstancesBis++;
	 * this.setCategorie(); }
	 */
